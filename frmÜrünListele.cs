...
namespace StokTakipUygulamasi
{
    public partial class frmÜrünListele : Form
    {
        ...
        private SqlConnection baglanti = new SqlConnection("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Stok_Takip;Integrated Security=True;Encrypt=False");
        ...
        private void txtBarkodNoAra_TextChanged(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlDataAdapter adtr = new SqlDataAdapter("select * from urun where barkodno like '%" + txtBarkodNoAra.Text + "%'", baglanti); //  Başta ve sonda o kelime veya harfi görünce listeleme yapar.
            adtr.Fill(tablo);
